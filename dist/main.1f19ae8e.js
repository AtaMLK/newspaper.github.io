...
var notValidMessage = document.querySelector(".not-valid-message");
var form = document.querySelector(".subscribe-form-main");
var email = document.querySelector("#email");
var thankEmail = document.querySelector('.email-adress');
var validateEmail = function validateEmail(emailValue) {
  return String(emailValue).toLowerCase().match(/^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|.(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/);
};
function submitForm() {
  subscribeButton.addEventListener("click", function (e) {
    ...
    if (validateEmail(emailValue)) {
      ...
      thankEmail.textContent = "".concat(email.value);
    } else {
